%% @author Roger
%% @doc @todo Add description to simple_cache_event_handler.


-module(simple_cache_event_handler).
-behaviour(gen_event).
...
%% API functions
%% ====================================================================
-export([delete_handler/0, add_handler/0]).
...
handle_event({delete, Key}, State) ->
	error_logger:info_msg("delete(~w, ~w)~n",[Key]),
    {ok, State};
